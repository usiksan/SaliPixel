...
History
  ...
  06.07.2022 v0.12 Append display current cursor position
  20.08.2022 v0.13 Append export to cpp file
             v0.14 Fix: wrong undo when size different than 32x32
*/
#ifndef SPCONFIG_H
#define SPCONFIG_H
